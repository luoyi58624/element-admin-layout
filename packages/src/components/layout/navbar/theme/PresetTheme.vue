<template>
  ...
  <div class="w-full flex flex-nowrap">
    <div
      ...
      <aside
        class="w-25/100 h-85/100 absolute top-15/100 left-0"
        :style="{ background: theme.layout.sidebar }" />
      <main
        class="w-75/100 h-85/100 absolute top-15/100 left-25/100"
        :style="{ background: theme.layout.section }" />
    </div>
  </div>
</template>
